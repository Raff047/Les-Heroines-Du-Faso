...
class ManagerCommunityPostScreen extends ConsumerStatefulWidget {
  final String postId;
  final String postImage;

  const ManagerCommunityPostScreen(this.postId, this.postImage, {super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _ManagerCommunityScreenState();
}

class _ManagerCommunityScreenState
    extends ConsumerState<ManagerCommunityPostScreen> {
  String commentTxt = '';
  ...
  void postComment() {
    if (commentTxt.isNotEmpty) {
      ...
      final newComment = CommunityComment(
          ...
          authorAvatarUrl: manager.profilePic,
