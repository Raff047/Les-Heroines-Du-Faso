...
import 'package:health_app/features/manager/community/screens/community_profile.dart';
...
class ManagerCommunityMainScreen extends ConsumerStatefulWidget {
  const ManagerCommunityMainScreen({super.key});

  @override
  ConsumerState<ManagerCommunityMainScreen> createState() =>
      _ManagerCommunityMainScreenState();
}

class _ManagerCommunityMainScreenState
    extends ConsumerState<ManagerCommunityMainScreen> {
        ...
        data: (communities) {
          ...
          void onCommunityTap(index) {
            ...
            Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        const ManagerCommunityProfileScreen()));
          }
